...
export function setupRazorpayWebhook(bot, adminBot) {
        ...
        if (event === 'payment_link.paid' || event === 'payment.captured') {
            ...
            if (appointment) {
                ...
                if (appointment.paymentMessageId) {
                    try {
                        await bot.telegram.editMessageText(appointment.telegramChatId, appointment.paymentMessageId, undefined, `✅ *Payment Received!* 🦷\n\nThank you for completing the payment. Your appointment is confirmed shortly.`, { parse_mode: 'Markdown' });
                    }
                    catch (e) {
...
Thank you for choosing BrightCare Dental! See you at your appointment. 🦷`;
                ...
                setTimeout(() => {
                    bot.telegram.sendMessage(appointment.telegramChatId, '📄 *One last thing:* Do you have any previous dental reports or X-rays to share with the doctor?', {
                        parse_mode: 'Markdown',
