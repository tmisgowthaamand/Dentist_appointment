...
export async function generateInvoicePDF(appointment: Appointment): Promise<Buffer> {
    const doc = new jsPDF();
    const primaryBlue: [number, number, number] = [52, 185, 227]; // #34B9E3
    const darkGrey: [number, number, number] = [51, 51, 51];
